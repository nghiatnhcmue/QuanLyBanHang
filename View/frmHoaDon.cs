...
namespace QL_BanHang.View
{
    public partial class frmHoaDon : Form
    {
        ...
        private void dtgvDSHD_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dpNgayLap.DataBindings.Clear();
            dpNgayLap.DataBindings.Add("Text", dtgvDSHD.DataSource, "NgayLap");
            cmbNhanVien.DataBindings.Clear();
            cmbNhanVien.DataBindings.Add("Text", dtgvDSHD.DataSource, "TenNV");
        ...
        {
            txtMa.Text = "";
            dpNgayLap.Text = DateTime.Now.Date.ToShortDateString();
            LoadcmbNhanVien();
            LoadcmbKhachHang();
        }
        ...
        private void txtSL_TextChanged(object sender, EventArgs e)
        {
            ...
            lbThanhTien.Text = (double.Parse(txtDonGia.Text) * int.Parse(txtSL.Text.Trim())).ToString();  
        }
